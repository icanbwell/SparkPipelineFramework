...
class FrameworkMappingLoader(FrameworkTransformer):
    ...
    def __init__(
        self,
        view: str,
        mapping_function: GetAutoMapperFunction,
        ...
        self.mapping_function: GetAutoMapperFunction = mapping_function
    ...
    def _transform(self, df: DataFrame) -> DataFrame:
        ...
        mapping_function: GetAutoMapperFunction = self.getMappingFunction()
    ...
    # noinspection PyPep8Naming,PyMissingOrEmptyDocstring
    def getMappingFunction(self) -> GetAutoMapperFunction:
